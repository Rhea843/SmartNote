...
const TrashNote = ({ notes, onDelete, onSelectNote,  onRestore }) => {
  ...
  return (
    <div className="h-screen bg-[#415A77] relative flex flex-col">
          ...
          <div className='overflow-y-auto flex-1 pb-36 lg:pb-20 scrollbar-thin scrollbar-track-[#415A77] scrollbar-thumb-[#778DA9] hover:scrollbar-thumb-[#1B263B]'>
            {notes.length === 0 ? (
              <p className="text-[16px] mt-42 md:mt-82 lg:mt-12 text-center text-gray-300">Your deleted notes will appear here.</p>
             ...
             filteredNotes.map((note) => (
                ...
                <p className="text-xs text-gray-900 font-bold text-right pr-2">
